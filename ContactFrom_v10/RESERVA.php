    ...
    <td>
				<div class="wrap-input100 validate-input" data-validate="Por favor, digite seu nome">
					...
					<span class="focus-input100"></span>
                            ...
                            <div class="wrap-input100 validate-input" data-validate="Por favor, digite seu sobrenome">
					<input class="input100" type="text" name="sobrename" placeholder="Digite seu sobrenome">
					<span class="focus-input100"></span>
				</div>

				

				<div class="wrap-input100 validate-input" data-validate = "Por favor, digite a data">
				
                                         
   <td align="center">
    <input class="input100" type="text" name="dia" size="2" maxlength="2" placeholder="Dia"> 
   <input class="input100" type="text" name="Mes" size="2" maxlength="2" placeholder="Mês"> 
    <input class="input100" type="text" name="ano" size="2" maxlength="4" placeholder="ano"> 
   </td>
					<span class="focus-input100"></span>
				</div>
